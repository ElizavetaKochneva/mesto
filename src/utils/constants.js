export const headers = {authorization : '649c29a4-78c9-4fa2-98a9-e4a7c9823c58',
                        'Content-Type': 'application/json'};
export const baseUrl = 'https://mesto.nomoreparties.co/v1/cohort-25';

export const popupAcceptanceSelector = '#popup_acceptance';
